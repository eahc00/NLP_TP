...
# 원본 JSON 파일 경로
input_file = '/home/eahc00/NLP/dataset/total_dataset.json'
...
# split_point2 = split_point + int((len(lines) - int(len(lines) * split_ratio)) * 0.5) 

# 데이터를 분할
data_part1 = lines[:split_point]
data_part2 = lines[split_point:]
# data_part3 = lines[split_point2:]
