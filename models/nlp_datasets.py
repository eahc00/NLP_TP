...
def get_dataset(
    ...
    dataset_path = json_data_path + f"{split}_dataset_split.json"
    ...
    def tokenize_and_label(sample):
        ...
        encoded_prompt= tokenizer.encode(tokenizer.bos_token + sample["prompt"],add_special_tokens=False, truncation=True, max_length=512)
        encoded_label = tokenizer.encode(sample["label"]+tokenizer.eos_token, add_special_tokens=False,truncation=True, max_length=256)
